...
export const orders: Order[] = [
  { id: "2018", table: 1, status: "new", items: 1, total: 13.5, paid: false, serviceDate: "2026-05-17", source: "qr" },
  { id: "2017", table: 4, status: "new", items: 2, total: 27, paid: false, serviceDate: "2026-05-17", source: "qr" },
  { id: "2016", table: 2, status: "payment_pending", items: 3, total: 31.5, paid: false, serviceDate: "2026-05-17", source: "qr" },
  { id: "2015", table: 5, status: "paid", items: 2, total: 42, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2014", table: 3, status: "preparing", items: 4, total: 56, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2013", table: 6, status: "ready", items: 2, total: 33, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2012", table: 8, status: "served", items: 3, total: 48, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2011", table: 9, status: "served", items: 2, total: 29, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2010", table: 10, status: "served", items: 5, total: 66, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2009", table: 11, status: "served", items: 3, total: 37.5, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2008", table: 12, status: "served", items: 2, total: 24, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2007", table: 13, status: "served", items: 4, total: 54.5, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2006", table: 14, status: "served", items: 2, total: 28, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2005", table: 15, status: "served", items: 3, total: 43, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2004", table: 16, status: "served", items: 2, total: 35, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2003", table: 17, status: "served", items: 5, total: 58, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2002", table: 18, status: "served", items: 2, total: 18, paid: true, serviceDate: "2026-05-17", source: "qr" },
  { id: "2001", table: 19, status: "served", items: 4, total: 98, paid: true, serviceDate: "2026-05-17", source: "service" },
  { id: "1999", table: 7, status: "served", items: 2, total: 22, paid: true, serviceDate: "2026-05-16", source: "qr" },
];
