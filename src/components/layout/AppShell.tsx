...
export function AppShell({
  ...
  const appearanceStyles = getAppearanceCssVars(undefined);
  const appearanceTheme = getAppearanceTheme(undefined);

  return (
    <div
      className={cn("tf-shell min-h-dvh bg-white text-slate-950", `tf-style-${appearanceTheme.style.toLowerCase()}`)}
