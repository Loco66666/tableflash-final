...
export default function StatisticsClient({ restaurantName }: { restaurantName: string }) {
  ...
  return (
    <AppShell>
      <PageHeader title={restaurantName} subtitle="Vue d’ensemble de votre activité" />
